...
const MerchantComingSoon = () => {
  const comingSoonProducts = [
    {
      id: 1,
      icon: Package,
      title: "Smart Inventory Control",
      abstract: "Predict stock needs before you run out. Automated reordering based on demand patterns and seasonal trends.",
    },
    {
      id: 2,
      icon: Users,
      title: "Vendor Hub & RFP Engine",
      abstract: "Streamline wholesale relationships. Generate RFPs, compare vendor quotes, and manage purchase orders in one place.",
    },
    {
      id: 3,
      icon: Megaphone,
      title: "Campaign Command Center",
      abstract: "Design, launch, and track promotions effortlessly. From flash sales to seasonal campaigns, all managed intelligently.",
    },
  ];
      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-12">
          ...
          <p className="text-xl md:text-2xl max-w-3xl leading-relaxed text-black/80">
            We're expanding the Merchant Intelligence Suite. Hover to discover what's in the pipeline.
          </p>

          {/* Products Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full max-w-7xl mt-12">
            {comingSoonProducts.map((product) => {
              const IconComponent = product.icon;
              return (
                <div key={product.id} className="relative group flip-card">
                  {/* Hover glow effect */}
          ...
          <div className="mt-8">
            <p className="text-base text-black/60 italic">
              ...and more merchant tools in development.
            </p>
          </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gray-50 border border-primary/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm hover:border-primary/40 transition-all duration-300">
                ...
                <p className="text-base md:text-lg text-black/70 mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
                  Be the first to unlock these merchant capabilities when they launch.
                </p>
...
export default MerchantComingSoon;